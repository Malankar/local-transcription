...
export function createMockApi(overrides: Partial<LocalTranscribeApi> = {}): LocalTranscribeApi {
  ...
  return {
    ...
    transcribeMeetingFile: vi.fn().mockResolvedValue(undefined),
    listMeetingImportConnectors: vi.fn().mockResolvedValue([]),
    discoverMeetingImports: vi.fn().mockResolvedValue([]),
    importMeetingFromIntegration: vi.fn().mockResolvedValue(undefined),
